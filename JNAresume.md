...
>![I'm on Twitter!](https://dl.dropboxusercontent.com/u/10606583/TwitterLogo.png =20x) @jillnagya  
...
An alumna of the Western Washington University Master of Arts archives program, I previously worked for the National Archives and Records Administration in Seattle, Washington - first, as an intern, then as a student employee. After an archival internship at Yellowstone National Park, I became an archives and records specialist for King County, providing first-line reference consultation and performing archival work along the entire records lifecycle for Road Services Division records - especially indexing and describing records using an extensive database and multiple indexes, maintaining quality control over description, and helping to create indexing standards through a controlled vocabulary.

- Excellent communicator  
- Friendly, knowledgeable customer service specialist  
- Graduated summa cum laude as an undergraduate  
- Self-motivated and detail-oriented problem-solver who sees obstacles as opportunities for growth and learning
- Wide-ranging technological experience with various operating systems and software, basic programming, digital reference services, Encoded Archival Description (EAD), Library of Congress Subject Headings (LCSH), Machine-Readable Cataloging (MARC), Dublin Core, and Microsoft Access
...
* Create metadata for existing and newly-accessioned records; correcting errors and obsolete information to accurately represent series; currently leading a team effort to create standardized description practices and a controlled vocabulary; provide back-up support by using NetBeans for automatic metadata creation and addition to repository  
* Digitize responsive records according to established standards as part of reference  
* Act as a subject matter expert as the Division’s only credentialed records professional, advising on internal records procedures as well as connecting reference needs to other repositories and information sources to provide complete records services; in this capacity, I have become a resource for other staff members and help guide work practices, including in submitting digitized images into Bizarro iDocs, our online repository  
...
* Evaluate physical condition of records, advise management regarding preservation needs, select supplies and tools required, and perform basic preservation activities, and assisted in evaluating conservation vendors during an RFP to ensure maximum value for a taxpayer-funded project  
...
* Process, arrange, re-house, and describe incoming and backlogged records in a variety of formats to facilitate retrieval, disposition, and long-term preservation  
...
* During the ramp-up to relocation, I successfully made the case for relinquishing two obsolete records storage machines in favor of accessioning the contents into our database system, making the records searchable and more accessible, while saving King County $12,000 in moving costs and reducing unnecessary complexity in our division’s record keeping processes  
* In 2014, performed analysis to identify potential pitfalls in a proposed $300,000, 5-year Division-wide digitization implementation program - analysis which resulted in further study of the program, other available options, and the intended scope before implementation
...
* Arranged and described the John Burger Photographs collection, using re:Discovery ICMS to generate a finding aid (available on the NPS site at www.nps.gov/yell/historyculture/manuscript.htm)   
* Processed 84 linear feet of the Park Facilities series  
* To generate interest and publicity, wrote blog posts on the Canyon Hotel, Cuthbert the National Park Pup, and noteworthy park correspondence  
...
As a first-year MA candidate and through firm belief in the power of public archives, I volunteered at the National Archives and Records Administration, working either individually or as part of a team to break through processing goals and make more records accessible. I gained knowledge about series as diverse as court exhibits (RG 21) to Forest Service records (RG 95) to the Bureau of Indian Affairs (RG 75).
...
* Created Facebook posts to promote interesting finds in the stacks and helped with lobby displays  
